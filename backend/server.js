...
const packages = [
  {
    ...
    minimumHours: 4,
    currency: 'EGP',
    description: '120 EGP/hr · Min 4 hrs, Max 8 hrs per day',
    descriptionAr: '١٢٠ جنيه/ساعة · الحد الأدنى ٤ ساعات، الحد الأقصى ٨ ساعات يومياً',
    duration: '1 day',
    note: 'Min 4 hrs, Max 8 hrs per day. Transportation calculated separately per day based on area.',
  },
  {
    id: 'weekly',
    name: 'Weekly Package',
    ...
    minimumHours: 20,
    currency: 'EGP',
    description: '100 EGP/hr · Min 20 hrs per week',
    descriptionAr: '١٠٠ جنيه/ساعة · الحد الأدنى ٢٠ ساعة أسبوعياً',
    duration: '1 week',
    note: 'Min 4 hrs, Max 8 hrs per day. Transportation calculated separately per day based on area.',
  },
  {
    ...
    currency: 'EGP',
    available: false,
    description: 'Coming soon — not available currently',
    descriptionAr: 'قريباً — غير متاحة حالياً',
    duration: '1 month',
    note: 'Monthly package is not available at this time.',
  },
];
